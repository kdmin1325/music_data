...
import 'package:piano_acquisition_application/screen/musicSheetInsertScreen2.dart';
...
class MusicSheetInsertScreen extends StatefulWidget {
  const MusicSheetInsertScreen({super.key});

  @override
  State<MusicSheetInsertScreen> createState() => _MusicSheetInsertScreenState();
}

class _MusicSheetInsertScreenState extends State<MusicSheetInsertScreen> {
  // futures
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text('음원 악보 삽입', textAlign: TextAlign.center,),
                          ...
                          child: Container(
                            child: ElevatedButton(
                              onPressed: (){
                                ...
                                Navigator.push(context, MaterialPageRoute(builder: (_)=>MusicSheetInsertScreen2()));
                              },
                              child: SingleChildScrollView(scrollDirection:Axis.horizontal ,child: Text('파트 정보', style: TextStyle(fontSize: 10.0, color: Colors.white), )),
